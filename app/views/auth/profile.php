                    ...
                    <div class="flex-column" style="gap: 1rem;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="student_id" value="<?php echo htmlspecialchars($user['student_id'] ?? ''); ?>"
                                   placeholder="For student promo eligibility">
                        </div>
            ...
            <div class="card">
                ...
                <div class="stats-grid">
                    <div class="flex-column" style="text-align: center; padding: 1rem; background: rgba(255,255,255,0.05); border-radius: 8px;">
                        ...
                        <div class="text-small text-muted">Total Bookings</div>
                    </div>
                    
                    <div class="flex-column" style="text-align: center; padding: 1rem; background: rgba(255,255,255,0.05); border-radius: 8px;">
                        <div style="font-size: 1.5rem; font-weight: 800; color: #27ae60;"><?php echo $stats['completed_bookings']; ?></div>
                        <div class="text-small text-muted">Completed</div>
                    </div>
        ...
        <div class="profile-main">
            ...
            <div class="card">
                <div class="flex-between" style="margin-bottom: 1.5rem;">
                    <h2 style="font-weight: 800;">Booking History</h2>
                        ...
                        <?php foreach ($bookings as $booking): ?>
                            <div class="booking-card">
                                <div class="booking-header">
                                    <div>
                                        <div style="font-weight: 700; margin-bottom: 0.25rem;">
                                            Table <?php echo $booking['table_number']; ?> • <?php echo $booking['floor_name']; ?>
                                        </div>
                                ...
                                <div class="booking-details" style="margin-top: 1rem;">
                                    <div class="text-small text-muted">
                                        Package: <?php echo $booking['package_name']; ?>
                                    </div>
            ...
            <!-- Payment History -->
            <div class="card">
                <h2 style="font-weight: 800; margin-bottom: 1.5rem;">Payment History</h2>
                    ...
                    <div class="flex-column" style="gap: 1rem;">
                        <?php foreach ($payments as $payment): ?>
                            <div class="payment-card payment-item">
                                <div style="flex: 1;">
                                    <div style="font-weight: 700; margin-bottom: 0.25rem;">
                                        Table <?php echo $payment['table_number']; ?>
                                    </div>
                                    <div class="text-small text-muted">
