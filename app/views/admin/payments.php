...
<div style="padding: 2rem 0;">
    ...
    <div style="display: flex; justify-content: between; align-items: center; margin-bottom: 2rem;">
        <div>
            <h1 style="font-size: 2.5rem; font-weight: 800; margin-bottom: 0.5rem;">
                Payment <span class="text-accent">Management</span>
            </h1>
        ...
        <div style="color: var(--text-muted); font-weight: 600;">
            Total Revenue: Rp <?php echo number_format($totalRevenue ?? 0, 0, ',', '.'); ?>
        </div>
    </div>
    ...
    <div class="card" style="margin-bottom: 2rem;">
        <div style="display: flex; gap: 1rem; align-items: center; flex-wrap: wrap;">
            <span style="font-weight: 700; color: var(--text-muted);">Filter by status:</span>
            ...
            <span style="font-weight: 700; color: var(--text-muted); margin-left: 1rem;">Method:</span>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <thead>
                        <tr style="border-bottom: 1px solid var(--border-color);">
                            <th style="padding: 1rem; text-align: left; font-weight: 700;">Payment ID</th>
                            <th style="padding: 1rem; text-align: left; font-weight: 700;">Customer</th>
                            <th style="padding: 1rem; text-align: left; font-weight: 700;">Booking</th>
                    ...
                    <tbody>
                        <?php foreach ($payments as $payment): ?>
                            <tr style="border-bottom: 1px solid var(--border-color);">
                                ...
                                <td style="padding: 1rem;">
                                    <div style="font-weight: 600;">Table <?php echo $payment['table_number']; ?></div>
                                    <div style="color: var(--text-muted); font-size: 0.9rem;">
                                        Booking #<?php echo str_pad($payment['booking_id'], 6, '0', STR_PAD_LEFT); ?>
                                    </div>
                                </td>
                                <td style="padding: 1rem;">
                                    <div style="font-weight: 700; color: var(--accent);">
        ...
        <?php else: ?>
            <div style="text-align: center; padding: 3rem; color: var(--text-muted);">
                ...
                <h3 style="font-weight: 700; margin-bottom: 0.5rem;">
                    No <?php echo ucfirst($status); ?> Payments
                </h3>
    ...
    <div class="card" style="margin-top: 2rem;">
        <h2 style="font-weight: 800; margin-bottom: 1.5rem;">Revenue Summary</h2>
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem;">
            <div style="text-align: center;">
                <div style="font-size: 2rem; margin-bottom: 0.5rem;">💰</div>
                <div style="font-weight: 700; margin-bottom: 0.25rem;">Today</div>
            ...
            <div style="text-align: center;">
                <div style="font-size: 2rem; margin-bottom: 0.5rem;">📊</div>
                <div style="font-weight: 700; margin-bottom: 0.25rem;">This Week</div>
                <div style="color: var(--accent); font-weight: 800; font-size: 1.2rem;">
            ...
            <div style="text-align: center;">
                <div style="font-size: 2rem; margin-bottom: 0.5rem;">📈</div>
                <div style="font-weight: 700; margin-bottom: 0.25rem;">This Month</div>
                <div style="color: var(--accent); font-weight: 800; font-size: 1.2rem;">
            ...
            <div style="text-align: center;">
                <div style="font-size: 2rem; margin-bottom: 0.5rem;">🎯</div>
                <div style="font-weight: 700; margin-bottom: 0.25rem;">Average/Day</div>
                <div style="color: var(--accent); font-weight: 800; font-size: 1.2rem;">
    ...
    modal.innerHTML = `
        <div style="background: var(--card-bg); padding: 2rem; border-radius: 12px; max-width: 500px;">
            ...
            <div style="display: flex; gap: 1rem; margin-top: 1rem;">
                <button onclick="approvePayment(${paymentId})" class="btn btn-primary">Approve</button>
                <button onclick="rejectPayment(${paymentId})" class="btn btn-outline">Reject</button>
                <button onclick="this.parentElement.parentElement.parentElement.remove()" class="btn btn-outline">Close</button>
            </div>
        </div>
    `;
...
function generateReceipt(paymentId) {
    alert('Generate receipt for payment ID: ' + paymentId);
...
function getPaymentStatusColor($status) {
    switch ($status) {
        ...
        case 'paid': return 'rgba(46, 204, 113, 0.2)';
        case 'failed': return 'rgba(231, 76, 60, 0.2)';
