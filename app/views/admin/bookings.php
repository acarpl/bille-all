...
<div style="padding: 1.5rem 0;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem; margin-bottom: 2rem;">
        <div>
            <h1 style="font-size: 2rem; font-weight: 800; margin-bottom: 0.5rem;">
                Manage <span class="text-accent">Bookings</span>
            </h1>
    ...
    <div class="card" style="margin-bottom: 2rem; padding: 1.25rem;">
        <div style="display: flex; gap: 0.75rem; align-items: center; flex-wrap: wrap; font-size: 0.95rem;">
            <span style="font-weight: 700; color: var(--text-muted); white-space: nowrap;">Filter by status:</span>
    ...
    <div class="card">
                ...
                <table style="width: 100%; border-collapse: collapse; min-width: 800px;">
                    <thead>
                        <tr style="border-bottom: 2px solid var(--border-color);">
                            <th style="padding: 1rem; text-align: left; font-weight: 700; color: var(--text-light);">Booking ID</th>
                            <th style="padding: 1rem; text-align: left; font-weight: 700; color: var(--text-light);">Customer</th>
                            <th style="padding: 1rem; text-align: left; font-weight: 700; color: var(--text-light);">Table</th>
                            <th style="padding: 1rem; text-align: left; font-weight: 700; color: var(--text-light);">Date & Time</th>
                            <th style="padding: 1rem; text-align: left; font-weight: 700; color: var(--text-light);">Duration</th>
                            <th style="padding: 1rem; text-align: left; font-weight: 700; color: var(--text-light);">Amount</th>
                            <th style="padding: 1rem; text-align: left; font-weight: 700; color: var(--text-light);">Status</th>
                            <th style="padding: 1rem; text-align: left; font-weight: 700; color: var(--text-light);">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <?php else: ?>
            <div style="text-align: center; padding: 3rem 1.5rem; color: var(--text-muted);">
                ...
                <h3 style="font-weight: 700; margin-bottom: 0.5rem; font-size: 1.4rem;">No Bookings Found</h3>
                <p style="font-size: 1rem;">No bookings match the selected filter.</p>
...
function startBilling(bookingId, durationHours) {
    if (!confirm('Start billing session for this booking? This will begin the countdown.')) {
        return;
    }
    ...
    .then(data => {
        if (data.success) {
            ...
            alert('❌ ' + (data.error || 'Failed to start billing'));
            button.disabled = false;
            button.innerHTML = '⏱️ Start Billing';
        }
    })
    .catch(error => {
...
function startCountdown(bookingId, totalMinutes) {
    ...
    const tick = () => {
        ...
        countdownEl.textContent = `⏱️ ${formatTime(minutesLeft)} left`;
        minutesLeft--;
